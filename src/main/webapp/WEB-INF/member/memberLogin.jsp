...
<div class="container">
  <h2>로그인</h2>
     ...
     <div>비밀번호를 입력하세요
     	<input type='password' name='pwd' value='asdf1234' class='form-control mb-2' required/>
     </div>
     <div>
     <button type="button" onclick="location.href='MemberJoin.mem'"class="btn btn-secondary form-control mb-2">회원가입</button>
