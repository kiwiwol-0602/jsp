...
<div class="container">
  ...
  <pre>
	...
	<div class="row text-center">
		...
		<div class="col"><a href="FileUpload4.st" class="btn btn-danger">업로드연습4</a></div>
	</div>
	<hr/>
	<div class='row'>
  	<div class='col'><a href="FileDownload.st" class="btn btn-primary form-control">다운로드폴더로 이동하기</a></div>
  	<div class='col'><a href="MemberMain.mem" class="btn btn-primary form-control">돌아가기</a></div>
  </div>
</div>
<p><br/></p>
