...
<head>
  ...
  <script>
    ...
    function scheduleInputView() {
    	...
    	str += '<option>성공의날</option>';
    	str += '<option>실패의날</option>';
    	str += '<option>반성(합리화)의날</option>';
    	str += '<option>주일</option>';
    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach var="vo" items="${vos}" varStatus="st">
	      <tr>
	        ...
	        <td>
	          <input type="button" value="수정" onclick="scheduleUpdateView('${vo.idx}','${vo.part}','${fn:replace(vo.content,newLine,'<br/>')}')" class="btn btn-primary btn-sm"/>
